...
public class IncludeTag extends AttributesTagSupport {
	...
	public int doEndTag() throws JspException {
		try {
			...
			page = applyApplicationAdapter(page);
	...
	protected String applyApplicationAdapter(String page) {
		...
		if (Validator.isNull(customJspServletContextName) || Validator.isNull(page)) {
			return page;
		}
